...
import com.wallet.cronnetwork.Mapper.ResetMapper;
...
public class ResetPwController {
    ...
    private String resetSmsSend(@RequestBody SmsDto smsDto) throws Exception{
        ...
        if(checkHpRes > 0){
            ...
            int updateCodeRes = cronCustomerMapper.insertAuthNumber(smsDto);
    ...
    public String resetPw(@RequestBody SmsDto smsDto) throws Exception{
        ...
        int checkRes = cronCustomerMapper.chkCode(smsDto);
